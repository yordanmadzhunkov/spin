...
pub fn infer_yolo_model_with_file(model_bin_name: &str, image_name: &str) {
...
// WASM NN, 
// TODO migrate to https://github.com/second-state/WasmEdge-WASINN-examples/blob/master/pytorch-yolo-image/README.md
#[http_component]
